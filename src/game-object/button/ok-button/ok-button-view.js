...
import {drawOkButton} from "../../../canvas/button/ok-button";
...
/** ケッテイボタンのビュー */
export class OkButtonView implements ButtonView {
  /** ボタンを描画するメッシュ */
  ...
  gameLoop(model: ButtonModel) {
    ...
    this._canvasMesh.draw(context => {
      ...
      drawOkButton(context, this._resources, model.depth, this._canvasMesh.canvas.width / 2, this._canvasMesh.canvas.height / 2);
