...
import { BattleAnimationTimeScales, parseBattleAnimationTimeScale, parseSoundVolume, parseWebGLPixelRatio, SoundVolumes, WebGLPixelRatios } from "../../../game/config/browser-config";
