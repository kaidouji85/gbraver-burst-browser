...
export function isConfigChanged(origin: GbraverBurstBrowserConfig, update: GbraverBurstBrowserConfig): boolean {
  return origin.webGLPixelRatio !== update.webGLPixelRatio || origin.battleAnimationTimeScale !== update.battleAnimationTimeScale || isSoundConfigChanged(origin, update);
}
