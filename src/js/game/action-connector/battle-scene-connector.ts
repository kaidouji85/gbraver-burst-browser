...
export const battleSceneConnector: TDSceneActionConnector<BattleScene> = (scene: BattleScene, gameAction: StreamSource<GameAction>) => [scene.gameEndNotifier().subscribe(v => {
  gameAction.next({
    type: "EndBattle",
    gameEnd: v.gameEnd,
