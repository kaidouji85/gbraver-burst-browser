 ...
 * @return 生成したストリーム
 */
export function toGameObjectActionObservable(update: Observable<Update>, preRender: Observable<PreRender>, overlap: Observable<OverlapAction>): Observable<GameObjectAction> {
