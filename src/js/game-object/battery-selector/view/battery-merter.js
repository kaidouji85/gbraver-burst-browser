...
export class BatteryMeter {
  ...
  constructor(resources: Resources) {
    ...
    this.#disk = new SimpleImageMesh({canvasSize: 1024, meshSize: 1024, image: disk, imageWidth: 539});
    ...
    this.#disActiveNumbers = R.times(R.identity, MAX_VALUE + 1)
    ...
    this.#numbers = R.times(R.identity, MAX_VALUE + 1)
    ...
    this.#needle = new SimpleImageMesh({canvasSize: 512, meshSize: 512, image: needle, imageWidth: 512});
