 ...
 * @return メッシュ
 */
export function shinBraverActiveBurstUp(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.SHIN_BRAVER_BURST_UP)?.texture ?? new THREE.Texture();
