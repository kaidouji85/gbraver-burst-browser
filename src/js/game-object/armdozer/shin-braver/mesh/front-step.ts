 ...
 * @return メッシュ
 */
export function shinBraverActiveFrontStep(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.SHIN_BRAVER_FRONT_STEP)?.texture ?? new THREE.Texture();
