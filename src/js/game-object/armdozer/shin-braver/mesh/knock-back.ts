 ...
 * @return メッシュ
 */
export function shinBraverActiveKnockBack(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.SHIN_BRAVER_KNOCK_BACK)?.texture ?? new THREE.Texture();
