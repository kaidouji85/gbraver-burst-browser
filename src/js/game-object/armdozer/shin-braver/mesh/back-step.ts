 ...
 * @return メッシュ
 */
export function shinBraverActiveBackStep(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.SHIN_BRAVER_BACK_STEP)?.texture ?? new THREE.Texture();
