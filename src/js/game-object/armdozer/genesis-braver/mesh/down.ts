 ...
 * @return 生成結果
 */
export function genesisBraverActiveDown(resources: Resources): ArmdozerAnimation {
 ...
 * @return 生成結果
 */
export function genesisBraverOutlineDown(resources: Resources): ArmdozerAnimation {
