...
export function createActiveMeshes(
  ...
  return [
    { type: "STAND", mesh: neoLandozerActiveStand(resources) },
    { type: "KNOCK_BACK", mesh: neoLandozerActiveKnockBack(resources) },
    { type: "GUARD", mesh: neoLandozerActiveGuard(resources) },
    { type: "GUTS_UP", mesh: neoLandozerGutsUp(resources) },
    { type: "GUTS_DOWN", mesh: neoLandozerGutsDown(resources) },
    { type: "FRONT_STEP", mesh: neoLandozerActiveFrontStep(resources) },
  ];
}
