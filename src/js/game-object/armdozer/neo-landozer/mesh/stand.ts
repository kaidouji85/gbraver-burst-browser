 ...
 * @return メッシュ
 */
export function neoLandozerActiveStand(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.NEO_LANDOZER_STAND)?.texture ?? new THREE.Texture();
