 ...
 * @return メッシュ
 */
export function neoLandozerActiveFrontStep(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.NEO_LANDOZER_FRONT_STEP)?.texture ?? new THREE.Texture();
