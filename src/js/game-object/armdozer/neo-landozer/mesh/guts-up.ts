 ...
 * @return メッシュ
 */
export function neoLandozerActiveGutsUp(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.NEO_LANDOZER_GUTS_UP)?.texture ?? new THREE.Texture();
