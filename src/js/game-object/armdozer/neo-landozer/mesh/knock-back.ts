 ...
 * @return メッシュ
 */
export function neoLandozerActiveKnockBack(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.NEO_LANDOZER_KNOCK_BACK)?.texture ?? new THREE.Texture();
