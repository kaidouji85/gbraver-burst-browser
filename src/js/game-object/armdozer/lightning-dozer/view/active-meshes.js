...
export function createActiveMeshes(
  ...
  return [
    { type: "KNOCK_BACK", mesh: lightningDozerActiveKnockBack(resources) },
    { type: "GUTS_UP", mesh: lightningDozerActiveGutsUp(resources) },
    { type: "GUTS_DOWN", mesh: lightningDozerActiveGutsDown(resources) },
    { type: "GUTS_TO_STAND", mesh: lightningDozerActiveGutsToStand(resources) },
    { type: "GUARD", mesh: lightningDozerActiveGuard(resources) },
    { type: "FRONT_STEP", mesh: lightningDozerActiveFrontStep(resources) },
    { type: "STAND", mesh: lightningDozerActiveStand(resources) },
  ];
}
