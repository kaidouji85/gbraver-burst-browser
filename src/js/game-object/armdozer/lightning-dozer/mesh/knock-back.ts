 ...
 * @return メッシュ
 */
export function lightningDozerKnockBack(resources: Resources): ArmdozerAnimation {
 ...
 * @return メッシュ
 */
export function lightningDozerActiveKnockBack(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.LIGHTNING_DOZER_KNOCK_BACK)?.texture ?? new THREE.Texture();
