 ...
 * @return メッシュ
 */
export function lightningDozerActiveGutsUp(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.LIGHTNING_DOZER_GUTS_UP)?.texture ?? new THREE.Texture();
