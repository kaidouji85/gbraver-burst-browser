 ...
 * @return メッシュ
 */
export function wingDozerActiveBackStep(resources: Resources): ArmdozerAnimation {
 ...
 * @return メッシュ
 */
export function wingDozerOutlineBackStep(resources: Resources): ArmdozerAnimation {
