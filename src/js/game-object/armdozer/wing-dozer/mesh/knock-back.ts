 ...
 * @return メッシュ
 */
export function wingDozerActiveKnockBack(resources: Resources): ArmdozerAnimation {
  const texture = resources.textures.find(v => v.id === TEXTURE_IDS.WING_DOZER_KNOCK_BACK)?.texture ?? new THREE.Texture();
