...
export function createActiveMeshes(
  ...
  return [
    { type: "STAND", mesh: wingDozerActiveStand(resources) },
    { type: "DASH_UP", mesh: wingDozerActiveDashUp(resources) },
    { type: "DASH_DOWN", mesh: wingDozerActiveDashDown(resources) },
    { type: "DASH_TO_STAND", mesh: wingDozerActiveDashToStand(resources) },
    { type: "FRONT_STEP", mesh: wingDozerActiveFrontStep(resources) },
    { type: "GUARD", mesh: wingDozerActiveGuard(resources) },
    { type: "KNOCK_BACK", mesh: wingDozerActiveKnockBack(resources) },
  ];
}
