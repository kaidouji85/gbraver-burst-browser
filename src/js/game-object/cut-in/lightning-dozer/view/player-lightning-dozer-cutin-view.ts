...
export class PlayerLightningDozerCutInView implements LightningDozerCutInView {
  ...
  constructor(resources: Resources) {
    ...
    const cutInUpResource = resources.textures.find(v => v.id === TEXTURE_IDS.LIGHTNING_DOZER_CUTIN_UP);
    ...
    const cutInDownResource = resources.textures.find(v => v.id === TEXTURE_IDS.LIGHTNING_DOZER_CUTIN_DOWN);
