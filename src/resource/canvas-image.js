...
export const CANVAS_IMAGE_IDS = {
  ...
  DEPRICATED_BATTERY_SLIDER_BASE: 'DEPRICATED_BATTERY_SLIDER_BASE',
  DEPRICATED_BATTERY_SLIDER_GAUGE: 'DEPRICATED_BATTERY_SLIDER_GAUGE',
  DEPRICATED_BATTERY_SLIDER_BACK: 'DEPRICATED_BATTERY_SLIDER_BACK',
  DEPRICATED_BATTERY_SLIDER_SHADOW: 'DEPRICATED_BATTERY_SLIDER_SHADOW',
...
export const CANVAS_IMAGE_CONFIGS: CanvasImageConfig[] = [
  ...
  {
    id: CANVAS_IMAGE_IDS.DEPRICATED_BATTERY_BAR_UP,
    path: 'gauge/battery-gauge/battery-bar-up.png',
  },
  {
    id: CANVAS_IMAGE_IDS.DEPRICATED_BATTERY_BAR_DOWN,
    path: 'gauge/battery-gauge/battery-bar-down.png',
  },
  {
    id: CANVAS_IMAGE_IDS.DEPRICATED_BATTERY_SLIDER_BASE,
    path: 'slider/depricated-battery-slider/battery-slider-base.png',
  },
  {
    id: CANVAS_IMAGE_IDS.DEPRICATED_BATTERY_SLIDER_GAUGE,
    path: 'slider/depricated-battery-slider/battery-slider-gauge.png',
  },
  {
    id: CANVAS_IMAGE_IDS.DEPRICATED_BATTERY_SLIDER_BACK,
