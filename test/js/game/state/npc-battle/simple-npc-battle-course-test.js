...
const stage1 = {stageName: 'test stage 1', npc: new NeoLandozerNPC()};
const stage2 = {stageName: 'test stage 2', npc: new NeoLandozerNPC()};
const stage3 = {stageName: 'test stage 3', npc: new NeoLandozerNPC()};
const stage4 = {stageName: 'test stage 4', npc: new NeoLandozerNPC()};
const stage5 = {stageName: 'test stage 5', npc: new NeoLandozerNPC()};
