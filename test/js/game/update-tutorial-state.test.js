...
const stage1 = {id: 'stage1', title: ['stage1'], player: {...EMPTY_PLAYER, playerId: 'player-01'}, npc: createEmptyNPC(), event: () => new EmptyCustomBattleEvent(), bgm: 'bgm01'};
const stage2 = {id: 'stage2', title: ['stage2'], player: {...EMPTY_PLAYER, playerId: 'player-02'}, npc: createEmptyNPC(), event: () => new EmptyCustomBattleEvent(), bgm: 'bgm02'};
const stage3 = {id: 'stage3', title: ['stage3'], player: {...EMPTY_PLAYER, playerId: 'player-03'}, npc: createEmptyNPC(), event: () => new EmptyCustomBattleEvent(), bgm: 'bgm03'};
