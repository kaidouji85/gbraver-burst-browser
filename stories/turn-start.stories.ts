...
import { enemyTurnStart, playerTurnStart } from "../src/js/game-object/turn-start";
...
const turnStartStory = (
  generator: (resources: Resources, gameObjectAction: Observable<GameObjectAction>) => TurnStart,
