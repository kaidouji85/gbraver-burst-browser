...
import { enemyLightning, playerLightning } from "../src/js/game-object/hitmark/lightning";
 ...
 */
const lightingStory = (
  generator: (resources: Resources, gameObjectAction: Observable<GameObjectAction>) => Lightning,
