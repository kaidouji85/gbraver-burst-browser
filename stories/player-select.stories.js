...
import { PlayerSelect } from "../src/js/game/dom-scene-binder/scene/player-select";
import { ArmdozerSelector } from "../src/js/game/dom-scene-binder/scene/player-select/armdozer-selector";
import { PilotSelector } from "../src/js/game/dom-scene-binder/scene/player-select/pilot-selector";
import { createPilotIcon } from "../src/js/game/dom-scene-binder/scene/player-select/pilot-selector/create-pilot-icon";
